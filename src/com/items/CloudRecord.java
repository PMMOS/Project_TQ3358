...
public class CloudRecord {
    ...
    public static List<CloudRecord> parseDevFilesByResult(byte[] pData) {
        List<CloudRecord> files = new ArrayList<CloudRecord>();
    ...
    static class ComparatorRecordFile implements Comparator<Object> {
