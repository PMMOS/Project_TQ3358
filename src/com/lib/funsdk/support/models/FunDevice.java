...
public class FunDevice {
	...
	public JSONObject getJson(){
		try {
			...
			jsonObject.put("ip", this.devIp);
			jsonObject.put("port", this.tcpPort);
			jsonObject.put("name", this.devIp+":"+this.tcpPort);
			jsonObject.put("channels", this.channel.nChnCount);
	...
	public void initWith(SDBDeviceInfo devInfo) {
		...
		if ( null != this.devName ) {
			this.devName = StringEscapeUtils.unescapeHtml(this.devName);
		}
